...
const SvgGooglePlay = ({ title = "Download on GooglePlay", ...props }) => {
  return (
    <SvgIcon
      title={title}
      {...props}
    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset=".169" stopColor="#feda77"></stop>
          <stop offset=".478" stopColor="#dd2a7b"></stop>
          <stop offset=".78" stopColor="#8134af"></stop>
          <stop offset="1" stopColor="#515bd4"></stop>
        </linearGradient>
        <linearGradient
          id="b"
          x1="43.83"
